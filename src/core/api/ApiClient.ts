...
export class ApiClient {
   ...
   * @param options - An optional object containing additional options for the request, such as headers, query parameters, or request body. The type of options is defined by the ResquestOption type for the GET method.
   ...
   */
  async get(endpoint: string, options: ResquestOption["Get"] = {}) {
   ...
   * @param options - An optional object containing additional options for the POST request, such as headers, query parameters, or request body. The type of options is defined by the ResquestOption type for the POST method.
   ...
   */
  async post(endpoint: string, options: ResquestOption["Post"] = {}) {
   ...
   * @param options - An optional object containing additional options for the PUT request, such as headers, query parameters, or request body. The type of options is defined by the ResquestOption type for the PUT method.
   ...
   */
  async put(endpoint: string, options: ResquestOption["Put"] = {}) {
   ...
   * @param options - An optional object containing additional options for the DELETE request, such as headers, query parameters, or request body. The type of options is defined by the ResquestOption type for the DELETE method.
   ...
   */
  async delete(endpoint: string, options: ResquestOption["Delete"] = {}) {
